...
{
    public class Version22: IReplace, FaultyVersion
    {
        public int[] FaultLines { get { return new int[] { 138,139,142,146 }; } }
        ...
        ref int j)
        {
            ...
            /*i = i + 1;*/ //FAULT: removed line
            if (arg[i+1] == NEGATE) //FAULT: changed condition
            {
                junk = addstr(NCCL, ref pat, ref j, MAXPAT);
                //i = i + 1 //FAULT: MOVED LINE;
            }
            else
