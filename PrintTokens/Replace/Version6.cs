...
{
    public class Version6: FaultyVersion, IReplace
    {
        public int[] FaultLines { get { return new int[] { 310, 315 }; } }
        public FaultType FaultType { get { return FaultType; } }
            ...
            int offset)
        {
            ...
            flag = false;
            i = offset + pat[offset];
            while ((i >= offset)) //FAULT: operator change
            {
                if (c == pat[i])
                {
                    flag = true;
                    break;//Mask of FAULT: was i = offset;
                }
                else
                    i = i - 1;
            }
