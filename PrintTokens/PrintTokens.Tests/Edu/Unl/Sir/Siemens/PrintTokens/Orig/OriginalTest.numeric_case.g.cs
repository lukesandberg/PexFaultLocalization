...
public void numeric_caseThrowsNullReferenceException314()
{
    Token token;
    token =
      this.numeric_case((TokenStream)null, (Token)null, (byte)0, (byte[])null, 0);
}
[TestMethod]
[PexGeneratedBy(typeof(OriginalTest))]
[PexRaisedException(typeof(NullReferenceException))]
public void numeric_caseThrowsNullReferenceException513()
{
    Token token;
    token =
      this.numeric_case((TokenStream)null, (Token)null, (byte)49, (byte[])null, 0);
}
[TestMethod]
[PexGeneratedBy(typeof(OriginalTest))]
...
public void numeric_caseThrowsIndexOutOfRangeException486()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      MemoryStream memoryStream;
...
public void numeric_case62()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ...
      characterStream.stream = bs1;
      byte[] bs2 = new byte[93];
      token = new Token();
      token.token_string = bs2;
      token.token_id = 0;
      TokenStream s0 = new TokenStream();
      s0.ch_stream = characterStream;
      byte[] bs3 = new byte[93];
      bs3[0] = (byte)9;
      bs3[1] = (byte)9;
      bs3[2] = (byte)9;
      bs3[3] = (byte)9;
      bs3[4] = (byte)9;
      bs3[5] = (byte)1;
      token1 = this.numeric_case(s0, token, (byte)0, bs3, 7);
      disposables.Dispose();
      Assert.IsNotNull((object)token1);
      Assert.IsNotNull((object)(token1.token_string));
      Assert.AreEqual<int>(93, token1.token_string.Length);
      Assert.AreEqual<byte>((byte)1, token1.token_string[0]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[1]);
      Assert.AreEqual<byte>((byte)9, token1.token_string[2]);
      Assert.AreEqual<byte>((byte)9, token1.token_string[3]);
      Assert.AreEqual<byte>((byte)9, token1.token_string[4]);
      Assert.AreEqual<byte>((byte)1, token1.token_string[5]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[6]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[7]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[8]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[9]);
...
public void numeric_case445()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ...
      bs3[1] = (byte)1;
      bs3[2] = (byte)9;
      token1 = this.numeric_case(s0, token, (byte)0, bs3, 4);
      disposables.Dispose();
      Assert.IsNotNull((object)token1);
      Assert.IsNotNull((object)(token1.token_string));
      Assert.AreEqual<int>(96, token1.token_string.Length);
...
public void numeric_case432()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ...
      characterStream = new CharacterStream();
      characterStream.fp = (Stream)memoryStream;
      characterStream.stream_ind = 109;
      characterStream.stream = bs1;
      byte[] bs2 = new byte[104];
      token = new Token();
      token.token_string = bs2;
      token.token_id = 0;
      TokenStream s0 = new TokenStream();
      s0.ch_stream = characterStream;
      byte[] bs3 = new byte[99];
      bs3[0] = (byte)1;
      bs3[1] = (byte)48;
      bs3[2] = (byte)48;
      bs3[3] = (byte)48;
      ...
      bs3[97] = (byte)48;
      bs3[98] = (byte)48;
      token1 = this.numeric_case(s0, token, (byte)48, bs3, 96);
      disposables.Dispose();
      Assert.IsNotNull((object)token1);
      Assert.IsNotNull((object)(token1.token_string));
      Assert.AreEqual<int>(104, token1.token_string.Length);
      Assert.AreEqual<byte>((byte)1, token1.token_string[0]);
      ...
      Assert.AreEqual<byte>((byte)1, token1.token_string[93]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[94]);
...
public void numeric_case719()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      ...
      Assert.AreEqual<byte>((byte)0, token1.token_string[1]);
      Assert.AreEqual<byte>((byte)9, token1.token_string[2]);
      Assert.AreEqual<byte>((byte)127, token1.token_string[3]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[4]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[5]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[6]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[7]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[8]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[9]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[10]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[11]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[12]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[13]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[14]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[15]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[16]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[17]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[18]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[19]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[20]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[21]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[22]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[23]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[24]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[25]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[26]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[27]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[28]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[29]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[30]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[31]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[32]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[33]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[34]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[35]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[36]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[37]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[38]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[39]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[40]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[41]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[42]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[43]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[44]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[45]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[46]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[47]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[48]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[49]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[50]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[51]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[52]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[53]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[54]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[55]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[56]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[57]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[58]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[59]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[60]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[61]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[62]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[63]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[64]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[65]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[66]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[67]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[68]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[69]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[70]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[71]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[72]);
      Assert.AreEqual<byte>((byte)49, token1.token_string[73]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[74]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[75]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[76]);
      Assert.AreEqual<byte>((byte)0, token1.token_string[77]);
...
[PexGeneratedBy(typeof(OriginalTest))]
[PexRaisedException(typeof(IndexOutOfRangeException))]
public void numeric_caseThrowsIndexOutOfRangeException77()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      MemoryStream memoryStream;
...
[PexGeneratedBy(typeof(OriginalTest))]
[PexRaisedException(typeof(IndexOutOfRangeException))]
public void numeric_caseThrowsIndexOutOfRangeException238()
{
    using (PexDisposableContext disposables = PexDisposableContext.Create())
    {
      MemoryStream memoryStream;
